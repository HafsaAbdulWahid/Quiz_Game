...
class myQuiz:  
    ...
    def buttons(self):  
        ...
        def do():
            ...
            msgbox=mb.askquestion("askquestion", "Are you sure?")   
            if msgbox == 'yes':
                guiWindow.destroy()
            else:
                mb.showinfo('Return','You will now return to the application screen')
